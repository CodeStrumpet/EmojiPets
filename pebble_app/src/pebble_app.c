...
static uint32_t SET1_FACES[] = {
    ...
    RESOURCE_ID_IMAGE_SET0_BORED_2,
    RESOURCE_ID_IMAGE_SET0_BORED_3,
    RESOURCE_ID_IMAGE_SET0_HAPPY_0,
    RESOURCE_ID_IMAGE_SET0_HAPPY_1,
    RESOURCE_ID_IMAGE_SET0_HAPPY_2,
    RESOURCE_ID_IMAGE_SET0_HAPPY_3,
    RESOURCE_ID_IMAGE_SET0_HUNGRY_0,
    RESOURCE_ID_IMAGE_SET0_INTRIGUED_0,
    RESOURCE_ID_IMAGE_SET0_INTRIGUED_1,
    RESOURCE_ID_IMAGE_SET0_INTRIGUED_2,
    RESOURCE_ID_IMAGE_SET0_INTRIGUED_3,
    RESOURCE_ID_IMAGE_SET0_WORRIED_0,
    RESOURCE_ID_IMAGE_SET0_WORRIED_1,
    RESOURCE_ID_IMAGE_SET0_WORRIED_2,
    RESOURCE_ID_IMAGE_SET0_WORRIED_3,
